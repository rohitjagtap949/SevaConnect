...
import 'models/animal_community_chat_model.dart';
import 'provider/animal_community_chat_provider.dart';

class AnimalCommunityChatScreen extends StatefulWidget {
  const AnimalCommunityChatScreen({Key? key})
      : super(
          key: key,
        );

  @override
  AnimalCommunityChatScreenState createState() =>
      AnimalCommunityChatScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => AnimalCommunityChatProvider(),
      child: AnimalCommunityChatScreen(),
    );
  }
}

class AnimalCommunityChatScreenState extends State<AnimalCommunityChatScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child:
                Selector<AnimalCommunityChatProvider, TextEditingController?>(
              selector: (
                context,
                provider,
              ) =>
