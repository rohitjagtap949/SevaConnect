...
import 'models/food_community_chat_model.dart';
import 'provider/food_community_chat_provider.dart';

class FoodCommunityChatScreen extends StatefulWidget {
  const FoodCommunityChatScreen({Key? key})
      : super(
          key: key,
        );

  @override
  FoodCommunityChatScreenState createState() => FoodCommunityChatScreenState();
  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => FoodCommunityChatProvider(),
      child: FoodCommunityChatScreen(),
    );
  }
}

class FoodCommunityChatScreenState extends State<FoodCommunityChatScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget _buildMessageRow(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Expanded(
            child: Selector<FoodCommunityChatProvider, TextEditingController?>(
              selector: (
                context,
                provider,
              ) =>
